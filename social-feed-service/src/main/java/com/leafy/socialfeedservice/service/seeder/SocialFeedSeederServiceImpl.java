...
import com.leafy.socialfeedservice.client.AuthServiceClient;
import com.leafy.socialfeedservice.client.PostRecommendationClient;
import com.leafy.socialfeedservice.client.UserServiceClient;
...
public class SocialFeedSeederServiceImpl implements SocialFeedSeederService {
    ...
    static final String[] PLACEHOLDER_VIDEO_URLS = {"https://samplelib.com/lib/preview/mp4/sample-5s.mp4", "https://samplelib.com/lib/preview/mp4/sample-10s.mp4", "https://samplelib.com/lib/preview/mp4/sample-15s.mp4", "https://samplelib.com/lib/preview/mp4/sample-20s.mp4", "https://samplelib.com/lib/preview/mp4/sample-30s.mp4", "https://samplelib.com/lib/preview/mp4/sample-12s.mp4"};
    ...
    private Post buildPostByType(PostType postType, List<String> userIds, Random random) {
        ...
        if (postType == PostType.REEL) {
            builder.musicId("seed-music-" + (1 + random.nextInt(50)));
        }

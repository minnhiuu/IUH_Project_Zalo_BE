...
import com.bondhub.socialfeedservice.service.comment.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<List<CommentResponse>>>> getRootCommentsByPost(
        ...
        return ResponseEntity.ok(ApiResponse.success(commentService.getRootCommentsByPost(postId, page, size, sortBy)));
    }
